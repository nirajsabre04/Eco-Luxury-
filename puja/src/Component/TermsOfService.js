...
const TermsOfService = () => {
  return (
    ...
    <li>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy, and Terms of Use for access or usage of domain name <a href="https://pujasamagri.online/">https://pujasamagri.online/</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</li>
    <li>The Platform is owned by PARAG KOSURKAR INDUSTRIES, a company incorporated under the Companies Act, 1956 with its registered office at B Wing, Lokmat Bhawan, Wardha Road, Lokmat Bhawan, Nagpur Ramdas Peth, Nagpur, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</li>
    ...
    <li>These Terms of Use can be modified at any time without assigning any reason. It is your responsibility to periodically review these Terms of Use to stay informed of updates.</li>
    ...
    <li>The use of Platform and/or availing of our Services is subject to the following Terms of Use:</li></ol>
...
jurisdiction of the courts in Nagpur and Maharashtra.</li>
